...
# 5. Use the `partial_application` method to create a new lambda that takes one argument and 
# returns the result of calling the original lambda with that argument and a fixed value
